    ...
    <aside className="w-64 bg-gray-900 border-r border-gray-800 flex flex-col shrink-0">
      ...
      <div className="px-5 py-5 border-b border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <span className="text-white font-semibold text-sm">{brandConfig.companyName}</span>
      ...
      <div className="px-3 pb-4 border-t border-gray-800 pt-4">
        <div className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-gray-800/50">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-gray-500 text-xs truncate">Acme Corporation</p>
          </div>
        </div>
        <Link
          href="/login"
          className="flex items-center gap-2 mt-2 px-3 py-2 rounded-lg text-gray-500 hover:text-gray-300 hover:bg-gray-800 text-xs transition-all"
        >
